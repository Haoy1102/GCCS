...
# Save CSVs
e1_equal_df.to_csv("./data_gen_hand/e1_equal.csv", index=False)
e1_unequal_df.to_csv("./data_gen_hand/e1_unequal.csv", index=False)
e2_df.to_csv("./data_gen_hand/e2_heterogeneity.csv", index=False)
e3_df.to_csv("./data_gen_hand/e3_longtail.csv", index=False)
e4_df.to_csv("./data_gen_hand/e4_ablation.csv", index=False)

# Also bundle into an Excel workbook
# with pd.ExcelWriter("/mnt/data_gen_hand/sim_results.xlsx", engine="xlsxwriter") as writer:
